...
public class Test {
    static final String projectDir = System.getProperty("user.dir")+System.getProperty("file.separator") + "td1";
    static final String datafile = projectDir+System.getProperty("file.separator")+"titles.txt";
